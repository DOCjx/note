        	...
        	<ul>
		        <li>
		        	<a href="<?php echo U('Index/game');?>">
		        		<img width="396px" height="213px" src="/abc/Homyit/Fun/Public/assets/global/img/game.png" alt="game">
		        		<span>
		        			<img width="720px" height="420px" src="/abc/Homyit/Fun/Public/assets/global/img/game.png" alt="game"><br>猜数字
		        		</span>
		        	</a>
		        </li>
		        <li>
			        <a href="<?php echo U('Index/game1');?>">
		        		<img width="396px" height="213px" src="/abc/Homyit/Fun/Public/assets/global/img/game1.png" alt="game1">
		        		<span>
		        			<img width="720px" height="420px" src="/abc/Homyit/Fun/Public/assets/global/img/game1.png" alt="game1"><br>心灵感应
		        		</span>
		        	</a>
		        </li>
		    </ul>
